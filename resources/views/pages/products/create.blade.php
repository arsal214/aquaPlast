<x-app-layout title="Create Services">

    <x-breadcrumb title="Create Services"  />
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-form :route="route('products.store')" :button="true">
{{--                            @include('pages.services.form')--}}
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    <div class="row g-2">
                                        ...
                                        <x-input name="name" :value="$product->name ?? null" :required="true"/>
                            ...
                            <x-input col="12" type="textarea" title="short description" name="short_description" :value="$service->short_description ?? null"
                                        />
