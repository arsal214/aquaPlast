<x-app-layout title="Service">
    ...
    <x-breadcrumb :title="'Product Details (' . $service->name . ')'" :backButton="route('users.suppliers.index')">
    </x-breadcrumb>
                            ...
                            <div class="row">
                                <div class="col-xl-7 col-12">
                                    <div class="row mb-0">
                                        ...
                                        <div class="col-sm-8">{{ isset($service?->supplier?->user) ? $service?->supplier?->user?->first_name . ' '. $service?->supplier?->user?->last_name : 'N/A' }}</div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row gap-2">
                                ...
                                <div class="col-4">
                                    <div class="row mb-0">
                                        <img src="{{$img->image}}" alt="{{$img->image}}" height="80px" width="auto">
                                    </div>
                                </div>
                                @endforeach
                            </div>
