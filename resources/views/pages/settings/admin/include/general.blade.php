<x-form :route="route('settings.store')">
    ...
    <div class="row g-2">
        ...
        <x-input col="6" title="Blog Shows Limit" name="values[blogs_show]" type="number" :value="adminSettings('blogs_show')" />

        <x-input col="12" title="Home Page Video" type="url" name="values[home_video_link]"
        ...
        <x-input col="4" title="Find Professional Image" name="values[final_professional_banner_image]" type="dropify" :defaultFile="asset('images/settings/'.adminSettings('final_professional_banner_image')) ?? null"
                 dropifyHeight="205" />
